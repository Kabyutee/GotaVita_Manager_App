...
assert(riskGate.includes("JARVIS evidence-first operating contract"), "JARVIS evidence-first gate missing");
...
assert(/Concrete runtime evidence: REQUIRED/.test(riskGate), "risk gate must explicitly require concrete runtime evidence");
assert(/Existing-record protection: REQUIRED/.test(riskGate), "risk gate must explicitly require existing-record protection");
assert(/Business scenario adaptation: REQUIRED/.test(riskGate), "risk gate must explicitly require business scenario coverage");
...
assert(sync.includes("createQueueId"), "deterministic queue identity helper missing");
