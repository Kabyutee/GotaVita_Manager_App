...
(function () {
  ...
  function ensureOrderWriteBoundaryLoaded() {
    ...
    script.defer = true;
    script.dataset.gvOrderWriteBoundary = "true";
    script.onerror = () => console.warn("GotaVita order write boundary failed to load.");
    (document.head || document.documentElement).appendChild(script);
  }
  ...
  // Load the Order write boundary before DOMContentLoaded so form listeners capture the wrapped handlers.
  ensureOrderWriteBoundaryLoaded();
