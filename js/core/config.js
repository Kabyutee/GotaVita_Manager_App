...
(function(){
  ...
  window.GV_CONFIG = Object.freeze({
    ...
    SYNC_RESOURCES:Object.freeze(["products","clients","services","orders","payments","expenses","payrollRecords","employees","orderGroups","deliveryRoutes","orderGroupItems","deliveryRouteItems","dailyReports","deletedOrders","auditLog"])
  });
})();