...
(function(){
  ...
  async function hydrateAuthorizedStateAfterAuth() {
    try {
      ...
      next._meta = Object.assign({}, next._meta, {
        lastUpdated: now, lastSynchronizedAt: now, cloudHydratedAt: now,
        cloudHydrationVersion: 2, cloudHydrationCounts: counts
      });
  ...
  function scheduleAuthorizedHydration() {
    // Legacy hydration is retained only for reference; canonical GVSync owns startup data flow.
    return false;
  }
